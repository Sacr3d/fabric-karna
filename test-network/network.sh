...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    . organizations/fabric-ca/enrollOrg1.sh
    ...
    . organizations/fabric-ca/enrollOrg2.sh
    ...
    . organizations/fabric-ca/enrollOrg3.sh
    ...
    . organizations/fabric-ca/enrollOrg4.sh
...
# genesis block is defiend using the "FourOrgsOrdererGenesis" profile at the bottom
...
function networkDown() {
  ...
  docker-compose -f $COMPOSE_FILE_BASE -f $COMPOSE_FILE_COUCH -f $COMPOSE_FILE_CA -f $COMPOSE_FILE_RAFT down --volumes --remove-orphans
...
COMPOSE_FILE_BASE=docker/docker-compose-peer4.yaml
# docker-compose.yaml file if you are using couchdb
COMPOSE_FILE_COUCH=docker/docker-compose-couch.yaml
# certificate authorities compose file
COMPOSE_FILE_CA=docker/docker-compose-ca.yaml
# certificate authorities compose file
COMPOSE_FILE_RAFT=docker/docker-compose-etcdraft4.yaml
#
